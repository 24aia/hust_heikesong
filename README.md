...
1. 下载最新版 [Mozilla 官方签名的 `5e852d620409484794bc-0.1.1.xpi`](https://github.com/24aia/hust_heikesong/releases/download/v0.1.1/5e852d620409484794bc-0.1.1.xpi)（默认推荐版本：`0.1.1`）。
